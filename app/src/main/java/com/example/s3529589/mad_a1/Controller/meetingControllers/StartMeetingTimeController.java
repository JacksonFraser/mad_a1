...
public class StartMeetingTimeController implements View.OnClickListener {
    private ScheduleMeetingActivity scheduleMeetingActivity;
    private TextView meetingTime;

    public StartMeetingTimeController(ScheduleMeetingActivity scheduleMeetingActivity, TextView meetingTime) {
